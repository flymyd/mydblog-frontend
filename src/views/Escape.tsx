    ...
    <FluidWrapper>
      <div style={{padding: 20, minHeight: '100vh'}}>
        <div className="flex flex-col justify-center items-center">
          <span className="font-bold text-3xl m-5">前端逃生舱</span>
        ...
        <Timeline color="dimmed" active={1} bulletSize={12} lineWidth={2}>
          <Timeline.Item color="green" title="2022-10-17 晚">
            <Card className="mt-3" shadow="sm" p="lg" radius="md" withBorder>
              <Text size="sm">前端瓦尔基里 <Text style={{cursor: 'pointer'}} variant="link" component="span" inherit>
                <a target="_blank" href={groupLink}>加入本群</a>
              </Text></Text>
